...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/1.jpg?raw=true "Ticks")
...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/2.jpg?raw=true "Test")
...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/3.jpg?raw=true "Test")
...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/4.jpg?raw=true "Test")
...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/5.jpg?raw=true "Test")
...
to the afternoon.
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/7.jpg?raw=true "Test")
3. Return to the chat window and type **time** and press return.
A message saying "Its afternoon" should appear.
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/8.jpg?raw=true "Test")
4. Type the command **/time set 12000** to change the time to the evening.
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/9.jpg?raw=true "Test")
5. Return to the chat window and type **time** and press return.
A message saying "Its evening" should appear.
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/10.jpg?raw=true "Test")
6. Type the command **/time set 15000** to change the time to night time.
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/11.jpg?raw=true "Test")
5. Return to the chat window and type **time** and press return.
A message saying "Its night" should appear.
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/12.jpg?raw=true "Test")
5. Run the command **/alwaysday** to return the day/night cycle back to the way it was before we started.
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.2.1/images/13.jpg?raw=true "Test")
