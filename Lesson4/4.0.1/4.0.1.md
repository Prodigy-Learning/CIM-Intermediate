...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.0.1/images/1.jpg?raw=true "Boolean")
...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.0.1/images/2.png?raw=true "ELSE")
...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.0.1/images/3.png?raw=true "ELSE")
...
![alt text](https://github.com/Prodigy-Learning/CodingInMinecraft-Intermediate/blob/master/Lesson4/4.0.1/images/4.png?raw=true "ELSE")
